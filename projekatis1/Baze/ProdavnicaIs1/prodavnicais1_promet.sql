...
CREATE TABLE `promet` (
  `idpromet` varchar(15) NOT NULL,
  `vrednost` int(11) DEFAULT NULL,
  `datum` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idpromet`),
  CONSTRAINT `idpromet` FOREIGN KEY (`idpromet`) REFERENCES `prodavnica` (`sifra`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `promet` VALUES ('Tehnomanija',1020000,'26-01-2018  12:40'),('WinWin',0,'26-01-2018 16:13');
