...
CREATE TABLE `menadzer` (
  `idmenadzer` varchar(15) NOT NULL,
  `ime` varchar(45) DEFAULT NULL,
  `prezime` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idmenadzer`),
  UNIQUE KEY `idmenadzer_UNIQUE` (`idmenadzer`),
  CONSTRAINT `idmenadzer` FOREIGN KEY (`idmenadzer`) REFERENCES `prodavnica` (`sifra`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `menadzer` VALUES ('Gigatron','Stefan','Stefanovic'),('Tehnomanija','Milan','Vasic'),('WinWin','Marko','Markovic');
